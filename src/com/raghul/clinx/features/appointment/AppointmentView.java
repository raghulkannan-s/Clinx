...
public class AppointmentView {
	...
	private void createAppointment() {
		...
		AppointmentDTO appointment = model.createAppointment(patientName, doctorName, date, timeSlot);
		System.out.println("Appointment created with ID: " + appointment.getAppointmentId());
	}

	private void listAppointments() {
		List<AppointmentDTO> appointments = model.getAppointments();
	...
	private void cancelAppointment() {
		...
		boolean removed = model.cancelAppointment(id);
